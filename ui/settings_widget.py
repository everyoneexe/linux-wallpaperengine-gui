...
class SettingsWidget(QWidget):
    ...
    def save_settings(self) -> None:
        ...
        try:
            ...
            if self.parent_window and hasattr(self.parent_window, 'show_toast'):
                self.parent_window.show_toast("✅ Settings saved!", 2000)
            ...
            if self.parent_window and hasattr(self.parent_window, 'show_toast'):
                self.parent_window.show_toast("❌ Settings could not be saved!", 3000)
    ...
    def reset_settings(self) -> None:
        ...
        try:
            ...
            if self.parent_window and hasattr(self.parent_window, 'show_toast'):
                self.parent_window.show_toast("🔄 Settings reset!", 2000)
    ...
    def closeEvent(self, event) -> None:
        ...
        if current_settings != saved_settings:
            logger.debug("There are unsaved changes")
